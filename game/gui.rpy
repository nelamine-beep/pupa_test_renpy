...
define gui.accent_color = u'#404040'
...
define gui.text_font = "animeacev3.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "animeacev3.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "animeacev3.ttf"
...
define gui.slot_button_text_yoffset = - 25
