...
screen say(who, what):
    ...
    if not renpy.variant("small"):
        add SideImage() xalign 0.1 yalign 1.0
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            textbutton _("{size=50}Начать"):
                text_style "mytextbutton"
                action Start()
            textbutton _("{size=50}Загрузить"):
                text_style "mytextbutton"
                action ShowMenu("load")
            textbutton _("{size=50}Достижения"):
                text_style "mytextbutton"
                action ShowMenu("gallery")
            textbutton _("{size=50}Настройки"):
                text_style "mytextbutton"
                action ShowMenu("preferences")
            # textbutton _("{size=50}Об игре"):
            #     text_style "mytextbutton"
            #     action ShowMenu("about")
            # textbutton _("{size=50}Помощь"):
            #     text_style "mytextbutton"
            #     action ShowMenu("help")

            textbutton _("{size=50}Выход"):
                text_style "mytextbutton"
    ...
    frame:
        ...
        vbox:
            ...
            frame:
                ...
                ypos 0.75
                yoffset -80
                label title xalign 0.5 yoffset -25

                vbox:
                    spacing 10
                    ypos gui.label_text_size + gui.text_size +50
                    xalign 0.5
                    hbox:
                        spacing 10
                        if not main_menu:
                    ...
                    hbox:
                        ...
                        textbutton _("Достижения") action ShowMenu("gallery")
